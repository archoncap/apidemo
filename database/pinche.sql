...
--
-- Host: localhost
-- Generation Time: 2017-01-07 21:55:59
-- 服务器版本： 5.6.23-log
-- PHP Version: 5.6.9
...
CREATE TABLE IF NOT EXISTS `pc_admin` (
  ...
  `loginedtimes` int(8) DEFAULT NULL,
...
INSERT INTO `pc_admin` (`id`, `username`, `roles_id`, `password`, `loginedtimes`, `lasttime`) VALUES
(1, 'admin', 1, 'e10adc3949ba59abbe56e057f20f883e', 91, 1483786031),
(2, 'user', 2, '132d4bacc660c537f2049694260a2751', 3, 1461122370),
(3, 'client', 4, '132d4bacc660c537f2049694260a2751', 0, NULL);
...
CREATE TABLE IF NOT EXISTS `pc_coinfo` (
  `id` int(11) NOT NULL,
  `co_name` varchar(128) NOT NULL,
  `co_address` varchar(256) NOT NULL,
  `co_postcode` varchar(16) NOT NULL,
  `co_lines` varchar(64) DEFAULT NULL,
  `co_phone` varchar(64) NOT NULL,
  `co_shouhou` varchar(64) DEFAULT NULL,
  `co_fax` varchar(64) DEFAULT NULL,
  `co_contacter` varchar(64) DEFAULT NULL,
  `co_email` varchar(128) DEFAULT NULL,
  `sitecode` text,
  `sitecodestatus` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `pc_coinfo` (`id`, `co_name`, `co_address`, `co_postcode`, `co_lines`, `co_phone`, `co_shouhou`, `co_fax`, `co_contacter`, `co_email`, `sitecode`, `sitecodestatus`, `title`, `keywords`, `description`) VALUES
(1, '中原顺风车', '河南郑州', '450000', '152,35,60', '13603458837', '0371-55673787', '0371-55673787', '007', 'vip360@163.com', '', 0, '中原顺风车', '中原顺风车', '中原顺风车');
...
--
-- 转存表中的数据 `pc_guestbook`
--

INSERT INTO `pc_guestbook` (`id`, `members_id`, `username`, `type`, `phone`, `email`, `addtime`, `content`, `reply`, `ip`, `status`) VALUES
(1, 4, 's_hover', 1, NULL, NULL, 1468813892, '页面可以设计的更好看点儿.', NULL, '', 0),
(2, 1, NULL, 1, NULL, NULL, 1474612944, '对有重大影响的专利侵权纠纷案件、假冒专利案件，国家知识产权局在必要时可以组织有关管理专利工作的部门处理、查处.', NULL, '127.0.0.1', 0),
(3, 1, '山东局', 1, NULL, NULL, 1474613113, '用于专利程序的生物材料保藏办法', NULL, '127.0.0.1', 0),
(4, 0, '', 1, NULL, NULL, 1474613831, '我想匿名访问，可以么', NULL, '127.0.0.1', 0);
...
CREATE TABLE IF NOT EXISTS `pc_images` (
  `id` int(8) NOT NULL,
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:欢迎页图 1:切换动图 2:弹出公告图 ',
...
INSERT INTO `pc_images` (`id`, `type`, `url`, `title`, `links`, `status`, `sortorder`) VALUES
(15, 1, 'http://pincheadmin.xinguanbio.com/uploads/Home/home-t1483786187.jpg', '中原顺风车', '', 1, 2),
(17, 1, 'http://pincheadmin.xinguanbio.com/uploads/Home/home-t1483786179.jpg', '中原顺风车', '', 1, 3),
(19, 1, 'http://pincheadmin.xinguanbio.com/uploads/Home/home-t1483786194.jpg', '中原顺风车01', '', 1, 1);
...
CREATE TABLE IF NOT EXISTS `pc_members` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:乘客 1:司机',
  `showname` varchar(32) NOT NULL,
  `sex` tinyint(1) NOT NULL DEFAULT '0',
  `logo` varchar(128) NOT NULL,
  `shenfenzheng` char(18) NOT NULL,
  `shenfenzheng_img` varchar(128) NOT NULL,
  `autobrand` varchar(64) NOT NULL,
  `autovin` varchar(16) NOT NULL,
  `auto_img` varchar(128) NOT NULL,
  `jiashizheng_img` varchar(128) NOT NULL,
  `address` varchar(128) NOT NULL,
  `email` varchar(64) NOT NULL,
  `sortorder` int(11) NOT NULL DEFAULT '500',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '认证状态 0：未提交 1：待认证 2：认证通过 3：认证失败',
...
INSERT INTO `pc_members` (`id`, `phone`, `password`, `type`, `showname`, `sex`, `logo`, `shenfenzheng`, `shenfenzheng_img`, `autobrand`, `autovin`, `auto_img`, `jiashizheng_img`, `address`, `email`, `sortorder`, `status`, `addtime`, `logintimes`, `lasttime`) VALUES
(1, '13643716360', 'e10adc3949ba59abbe56e057f20f883e', 1, '任我行', 0, '', '', 'http://pinche.xinguanbio.com/uploads/shenfenzheng/201701/logo-t1483785639.jpg', '点点滴滴', '122222', '', '', '', '', 600, 1, '2016-12-06 16:00:00', 24, 1483796033),
(2, '13643716362', 'e10adc3949ba59abbe56e057f20f883e', 0, '阿萨德', 0, '', '', '', '', '', '', '', '济南市经十东路157号', 'wanghaifeng@sdipo.gov.cn', 700, 1, '2016-12-12 16:00:00', 0, 1475201174),
(3, '13643716363', 'e10adc3949ba59abbe56e057f20f883e', 0, '击飞', 0, '', '', '', '', '', '', '', '济南市经十东路157号', 'wanghaifeng@sdipo.gov.cn', 500, 0, '2016-12-26 22:00:00', 0, 1473404801),
(4, '13643716364', '132d4bacc660c537f2049694260a2751', 1, '阿斯蒂芬', 0, '', '', '', '', '', '', '', '青岛市', '34752931@qq.com', 800, 0, '2016-12-27 02:00:24', 0, 1471570392),
(5, '13222333322', '96e79218965eb72c92a549dd5a330112', 0, '猜猜我是谁', 0, 'http://pinche.xinguanbio.com/uploads/logo/201701/logo-t1483720148.jpg', '', 'http://pinche.xinguanbio.com/uploads/shenfenzheng/201701/logo-t1483779503.jpg', '', '', 'http://pinche.xinguanbio.com/uploads/auto/201701/logo-t1483792112.jpg', 'http://pinche.xinguanbio.com/uploads/jiashizheng/201701/logo-t1483792276.jpg', '郑州市管城区西大街', '2222333@qq.com', 500, 2, '0000-00-00 00:00:00', 23, 1483788428),
(6, '13222333320', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483194763),
(7, '13222333321', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483194876),
(8, '13222333333', '96e79218965eb72c92a549dd5a330112', 0, '阿毛', 0, '', '', '', '', '', '', '', '这种事', '', 500, 3, '0000-00-00 00:00:00', 1, 1483195072),
(9, '13603458837', 'e10adc3949ba59abbe56e057f20f883e', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 18, 1483788612),
(10, '15503717273', 'e10adc3949ba59abbe56e057f20f883e', 1, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 16, 1483785740),
(11, '13222333324', '96e79218965eb72c92a549dd5a330112', 1, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483236293),
(12, '18639005616', '050aaf0e8c5f992ec8b9fe7112522db6', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483240446),
(13, '13700887983', '1960cb4061d6c45c08152b6d1e4127f2', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483240709),
(14, '15638511583', 'e10adc3949ba59abbe56e057f20f883e', 0, 'hover', 0, '', '', '', '', '', '', '', 'myaddress', '32545865@qq.com', 500, 1, '0000-00-00 00:00:00', 6, 1483782164),
(15, '13212341234', 'e10adc3949ba59abbe56e057f20f883e', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483251553),
(16, '13222333331', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483451318),
(17, '13222333332', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483452646),
(18, '13222333334', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483452918),
(19, '13222333335', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483452959),
(20, '13222333336', '96e79218965eb72c92a549dd5a330112', 0, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 1, 1483453809),
(21, '13222333337', '96e79218965eb72c92a549dd5a330112', 1, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 2, 1483453912),
(22, '13222333340', '96e79218965eb72c92a549dd5a330112', 1, '', 0, '', '', '', '', '', '', '', '', '', 500, 1, '0000-00-00 00:00:00', 5, 1483455004);
...
INSERT INTO `pc_pages` (`id`, `title`, `keywords`, `content`, `addtime`, `status`) VALUES
(1, '关于我们', '关于我们', '<p>中原顺风车，为河南跨城出行者服务。</p><p><br /></p><p>中原顺风车致力于打造一个安全、便捷的跨城拼车平台。</p>', 1483757799, 1),
(2, '服务协议', '服务协议', '<p><span style="font-size:undefined"></span>中原顺风车非常重视对用户（以下简称“您”或“用户”）隐私的保护，为了给您提供更准确、更有个性化的服务，请您仔细阅读如下声明。当您访问中原顺风车网站或使用中原顺风车提供的服务前，您需要同意隐私政策中具体个人信息的收集、使用、公布和以其它形式使用和披露您的个人信息等内容。但中原顺风车会以高度的勤勉、审慎义务对待您的个人信息。除本隐私权政策另有规定外，在未征得您事先许可的情况下，中原顺风车不会将这些信息对外披露或向第三方提供。如果您不同意隐私政策中的任何内容，请立即停止使用或访问中原顺风车。本协议为中原顺风车用户许可协议不可分割的组成部分。</p><p><br />一、中原顺风车隐私政策的适用范围<br />1.1适用范围<br />1.1.1在您注册中原顺风车时，您根据中原顺风车要求提供的个人注册信息，包括但不限于姓名、地址、联系方式等；&nbsp;<br />1.1.2在您使用中原顺风车网络服务，或访问中原顺风车平台网页时，中原顺风车自动接收并记录您的浏览器和计算机上的信息，包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据；&nbsp;<br />1.1.3中原顺风车通过合法途径从商业伙伴处取得的用户个人数据。<br />1.2您了解并同意，以下信息不适用本隐私权政策：<br />1.2.1您在使用中原顺风车平台提供的搜索服务时输入的关键字信息；<br />1.2.2中原顺风车收集到的您在中原顺风车发布的有关信息数据，包括但不限于成交信息及评价详情；<br />1.2.3违反法律规定或违反中原顺风车规则行为及中原顺风车已对您采取的措施。</p><p><br />二、中原顺风车收集信息的使用<br />2.1中原顺风车利用从所有服务中收集的信息来提供、维护、保护和改进这些服务，同时开发新的服务为您带来更好的用户体验，并提高中原顺风车的总体服务品质。中原顺风车还会向您提供您感兴趣的信息，包括但不限于向您发出产品和服务信息，或者经您的事先同意，与中原顺风车合作伙伴共享信息以便他们向您发送有关其产品和服务的信息。<br />2.2中原顺风车不会向任何无关第三方（即不包括中原顺风车的关联公司或合作公司）提供、出售、出租、分享或交易您的个人信息，除非事先得到您的许可，或该无关第三方和中原顺风车（含中原顺风车关联公司）单独或共同为您提供服务时，在该服务结束后，其将被禁止访问包括其以前能够访问的所有这些资料。<br />2.3中原顺风车亦不允许任何第三方以任何手段收集、编辑、出售或者无偿传播您的个人信息。任何中原顺风车平台用户如从事上述活动，一经发现，中原顺风车有权立即终止与该用户的服务协议。</p><p><br />三、您完全理解并不可撤销地、免费地授予中原顺风车及其关联公司下列权利<br />3.1中原顺风车关联公司或合作公司允许中原顺风车用户登录关联公司或合作公司并使用其服务，中原顺风车用户在关联公司或合作公司的任何行为均需遵守该等平台服务协议的约定、平台公布的规则以及有关正确使用平台服务的说明和操作指引。为了实现上述功能，您同意中原顺风车将您在中原顺风车的注册信息、交易/支付数据等信息和数据同步至关联公司或合作公司系统并允许其使用。<br />3.2如您以中原顺风车关联公司或合作公司用户账号和密码登录中原顺风车，为了实现向您提供同等服务的功能，您同意中原顺风车将您在关联公司或合作公司账号项下的注册信息、交易/支付数据等信息和数据同步至中原顺风车系统并进行使用，并且您不会因此追究中原顺风车以及中原顺风车关联公司或合作公司的责任。<br />3.3为确保交易安全，允许中原顺风车及其关联公司对用户信息进行数据分析，并允许中原顺风车及其关联公司对上述分析结果进行商业利用。<br />3.4您在享受中原顺风车提供的各项服务的同时，授权并同意接受中原顺风车向您的电子邮件 手机、通信地址等发送商业信息，包括不限于最新的中原顺风车产品信息、促销信息等。若您选择不接受中原顺风车提供的各类信息服务，您可以按照中原顺风车网提供的相应设置拒绝该类信息服务。<br />3.5用户在如下情况下，中原顺风车会遵照您的意愿或法律的规定披露您的个人信息，由此引发的问题将由您个人承担：<br />3.5.1事先获得您的同意向第三方披露；<br />3.5.2为提供您所要求的产品和服务，而必须与第三方分享您的个人信息；<br />3.5.3根据有关的法律法规的规定，或者依据行政机关或司法机关的要求，向第三方或者行政、司法机构披露；<br />3.5.4如您是适格的知识产权投诉人并已提起投诉，应被投诉人要求，向被投诉人披露，以便双方处理可能的权利纠纷；<br />3.5.5如您出现违反中国有关法律、法规或者中原顺风车服务协议或相关规则的情况，需要向第三方披露；<br />3.5.6在中原顺风车上创建的某一交易中，如交易任何一方履行或部分履行了交易义务并提出信息披露请求的，中原顺风车有权决定向该用户提供其交易对方的联络方式等必要信息，以促成交易的完成或纠纷的解决；<br />3.5.7其他中原顺风车根据法律、法规或者中原顺风车政策认为合适的披露。</p><p><br />四、信息存储和交换<br />4.1中原顺风车收集的有关您的信息和资料将保存在中原顺风车及（或）其关联公司的服务器上，这些信息和资料可能传送至您所在国家、地区或中原顺风车收集信息和资料所在地的境外并在境外被访问、存储和展示。</p><p><br />五、Cookies的使用<br />5.1在您未拒绝接受cookies的情况下，中原顺风车会在您的计算机上设定或取用cookies，以便您能登录或使用依赖于cookies的中原顺风车服务或功能。中原顺风车使用cookies可为您提供更加周到的个性化服务，包括推广服务。<br />5.2您有权选择接受或拒绝接受cookies。您可以通过修改浏览器设置的方式拒绝接受cookies。但如果您选择拒绝接受cookies，则您可能无法登录或使用依赖于cookies的中原顺风车服务或功能。<br />5.3通过中原顺风车所设cookies所取得的有关信息，将适用本政策。</p><p><br />六、中原顺风车对信息的维护与保护<br />6.1中原顺风车希望用户放心的使用中原顺风车的产品和服务，为此中原顺风车设置了安全程序保护您的信息不会被未经授权的人访问、窃取。但也请您妥善保管您的账户信息。中原顺风车将通过向其它服务器备份、对用户密码进行加密等安全措施确保您的信息不丢失，不被滥用和变造。尽管有前述安全措施，但同时也请您注意在信息网络上不存在绝对完善的安全措施。<br />6.2在使用中原顺风车服务进行网上交易时，您不可避免的要向交易对方或潜在的交易对方披露自己的个人信息，如联络方式或者邮政地址。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。如您发现自己的个人信息泄密，请您立即联络中原顺风车客服，以便中原顺风车采取相应措施。</p><p><br />七、合作伙伴<br />7.1中原顺风车选择有信誉的第三方公司或网站作为中原顺风车的合作伙伴为用户提供信息和服务，尽管中原顺风车只选择有信誉的公司或网站作为中原顺风车的合作伙伴，但是每个合作伙伴都会有与中原顺风车不同的隐私条款，一旦您通过点击进入了合作伙伴的网站，中原顺风车的隐私条款将不再生效，中原顺风车建议您查看该合作伙伴网站的隐私条款，并了解该合作伙伴对于收集、使用、披露您的个人信息的规定。</p><p><br />八、关于隐私条款的变更<br />8.1中原顺风车将根据法律、法规或政策的变更和修改，或中原顺风车网站内容的变化和技术的更新，或其他中原顺风车认为合理的原因，对本隐私政策进行修改并以网站公告、用户通知等合适的形式告知用户，若您不接受修订后的条款的，应立即停止使用本服务，若您继续使用本服务的，视为接受修订后的所有条款。<br /></p>', 1483757394, 1),
(3, '版本更新', '版本更新', '<p><br /></p><p>版本更新</p>', 1482562810, 1),
(10, '售后服务', '售后服务', '<p><img src="/uploads/Pages/pages-t1462501471.jpg" alt="" /><br /></p><p><br /></p><p>其实还是摩托部队！<br /></p>', 1462761877, 1);
...
CREATE TABLE IF NOT EXISTS `pc_prefare` (
  `id` int(11) NOT NULL,
  `pretrip_id` int(11) NOT NULL,
...
INSERT INTO `pc_prefare` (`id`, `pretrip_id`, `starton`, `endon`, `money`) VALUES
(1, 2, '06:00:00', '12:00:00', '30'),
(2, 2, '08:00:00', '13:00:00', '40'),
(3, 2, '15:00:00', '19:00:00', '50'),
(4, 2, '18:00:00', '21:00:00', '60'),
(5, 3, '06:00:00', '10:00:00', '50'),
(6, 3, '16:00:00', '22:00:00', '80'),
(7, 4, '13:30:00', '17:00:00', '120'),
(8, 4, '18:00:00', '21:30:00', '110');
...
CREATE TABLE IF NOT EXISTS `pc_pretrip` (
  `id` int(11) NOT NULL,
...
INSERT INTO `pc_pretrip` (`id`, `fromcity`, `tocity`) VALUES
(2, '郑州市', '洛阳市'),
(3, '开封市', '安阳市'),
(4, '南阳市', '郑州市');
...
INSERT INTO `pc_roles` (`id`, `rolename`, `controllers`, `created`, `updated`) VALUES
(1, '系统管理员', 'Admin,Members,Pages,System,Trip', NULL, NULL),
(2, '普通会员', 'Admin', NULL, NULL),
(3, 'EVERYONE', 'Error,Index,Public', NULL, NULL),
(4, '客户组', 'User', 1461124127, 1461124127);
...
CREATE TABLE IF NOT EXISTS `pc_trip` (
  `id` int(11) NOT NULL,
  `members_id` int(11) NOT NULL,
  `fromcity` varchar(32) NOT NULL,
  `fromplace` varchar(128) NOT NULL,
  `tocity` varchar(32) NOT NULL,
  `toplace` varchar(128) NOT NULL,
  `money` decimal(11,2) NOT NULL,
  `startdate` datetime NOT NULL,
  `seat` tinyint(4) NOT NULL DEFAULT '5',
  `rest` tinyint(4) NOT NULL DEFAULT '5',
  `location` varchar(32) NOT NULL DEFAULT '',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:可预约 2:已出发 3:取消 4:已结束'
...
INSERT INTO `pc_trip` (`id`, `members_id`, `fromcity`, `fromplace`, `tocity`, `toplace`, `money`, `startdate`, `seat`, `rest`, `location`, `addtime`, `status`) VALUES
(1, 1, '', '郑州金水区', '', '新乡', '30.00', '0000-00-00 00:00:00', 5, 0, '34.8939528243,113.4959253378', '2016-12-24 00:44:59', 2),
(2, 2, '', '郑州中原区中原路', '', '许昌', '50.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-24 16:44:59', 1),
(3, 3, '', '郑州金水区文化路东段', '', '南阳', '60.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-25 16:44:59', 1),
(4, 4, '', '郑州郑东新区黄河南路', '', '焦作', '70.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-26 16:44:59', 1),
(5, 1, '', '郑州惠济区南阳路段', '', '商丘', '80.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-27 16:44:59', 1),
(6, 2, '', '郑州管城区', '', '濮阳', '90.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-28 16:44:59', 1),
(7, 3, '', '郑州二七区火车站', '', '信阳', '40.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-29 16:44:59', 1),
(8, 4, '', '郑州二七区火车站', '', '洛阳', '30.00', '0000-00-00 00:00:00', 5, 5, '34.8939528243,113.4959253388', '2016-12-29 16:44:59', 1),
(9, 1, '', '郑州市金水区东风路段', '', '南阳市', '80.00', '0000-00-00 00:00:00', 7, 7, '34.8939528243,113.4959253378', '2016-12-28 03:37:34', 1),
(10, 1, '', '北京', '', '郑州', '120.00', '0000-00-00 00:00:00', 5, 110, '35.8240980000,111.7856780000', '2016-12-30 14:53:58', 1),
(11, 1, '', '郑州', '', '武汉', '58.00', '0000-00-00 00:00:00', 10, 5, '', '2016-12-31 08:39:23', 1),
(12, 1, '', '郑州', '', '南阳', '69.00', '0000-00-00 00:00:00', 40, 36, '', '2016-12-31 09:07:31', 1),
(13, 1, '', '南京', '', '上海', '566.00', '0000-00-00 00:00:00', 32, 23, '', '2016-12-31 09:11:08', 1),
(14, 9, '', '郑州', '', '周口', '50.00', '0000-00-00 00:00:00', 6, 5, '', '2017-01-01 01:48:28', 1),
(15, 10, '', '郑州', '', '周口', '50.00', '0000-00-00 00:00:00', 5, 0, '', '2017-01-01 01:53:00', 2),
(16, 11, '', '河南郑州', '', '河南南阳', '110.00', '0000-00-00 00:00:00', 8, 5, '', '2017-01-01 02:07:01', 1),
(17, 9, '', '郑州', '', '南阳', '50.00', '0000-00-00 00:00:00', 5, 0, '', '2017-01-01 02:51:31', 2),
(18, 12, '', '郑州', '', '项城', '60.00', '0000-00-00 00:00:00', 7, 6, '', '2017-01-01 03:16:21', 1),
(19, 1, '郑州市', '郑州火车站', '洛阳市', '洛阳火车站', '30.00', '0000-00-00 00:00:00', 20, 0, '', '2017-01-04 14:18:10', 1),
(20, 5, '郑州市', '郑州北站', '洛阳市', '洛阳南站', '30.00', '2017-01-05 00:00:00', 20, 0, '', '2017-01-05 15:24:35', 1),
(21, 5, '郑州', '郑州西站', '洛阳', '洛阳南站', '30.00', '2017-01-05 00:00:00', 20, 10, '', '2017-01-05 15:34:22', 1),
(22, 5, '开封市', '开封龙厅', '安阳市', '洛阳白马寺', '80.00', '2017-01-05 00:00:00', 22, 0, '', '2017-01-05 15:39:34', 4),
(23, 10, '郑州市', '花园路', '洛阳市', '大佛', '30.00', '2017-01-06 00:00:00', 7, 0, '', '2017-01-05 19:01:53', 2),
(24, 10, '郑州市', '地铁口', '洛阳市', '火车站', '30.00', '2017-01-12 00:00:00', 5, 3, '', '2017-01-06 06:59:04', 1),
(25, 14, '郑州市', 'dghxgxg', '洛阳市', 'chf6ydhx', '30.00', '2017-01-07 00:00:00', 5, 5, '', '2017-01-07 09:43:57', 1),
(26, 1, '郑州市', '火车站', '洛阳市', '地铁口', '30.00', '2017-01-05 13:30:00', 5, 3, '', '2017-01-07 10:30:47', 1),
(27, 10, '开封市', '鼓楼', '安阳市', '博物馆', '50.00', '2017-01-09 03:35:00', 5, 0, '', '2017-01-07 10:39:55', 2),
(28, 10, '郑州市', '二七塔', '洛阳市', '龙门', '50.00', '2017-01-19 18:56:00', 7, 3, '', '2017-01-07 10:56:01', 1),
(29, 10, '南阳市', '诸葛', '郑州市', '二七塔', '110.00', '2017-01-20 18:58:00', 5, 0, '', '2017-01-07 10:57:49', 2);
...
CREATE TABLE IF NOT EXISTS `pc_trip_order` (
  `id` int(11) NOT NULL,
  `trip_id` int(11) NOT NULL,
  `members_id` int(11) NOT NULL,
  `contact` varchar(32) NOT NULL,
  `tel` varchar(32) NOT NULL,
  `bookseat` int(11) NOT NULL,
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0:等待确认 1:已确认 2:已拒绝 3:已取消'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `pc_trip_order`
--

INSERT INTO `pc_trip_order` (`id`, `trip_id`, `members_id`, `contact`, `tel`, `bookseat`, `addtime`, `status`) VALUES
(1, 1, 2, '', '', 0, '2016-12-24 00:49:04', 1),
(2, 29, 9, 'zhangsan', '13603458837', 1, '2017-01-07 13:46:34', 1);

-- --------------------------------------------------------

--
-- 表的结构 `pc_trip_order_log`
--

CREATE TABLE IF NOT EXISTS `pc_trip_order_log` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pc_zone_area` (
  `id` int(8) NOT NULL,
...
--
-- 转存表中的数据 `pc_zone_area`
--

INSERT INTO `pc_zone_area` (`id`, `code`, `name`, `citycode`) VALUES
(1, '110101', '东城区', '110100'),
(2, '110102', '西城区', '110100'),
(3, '110103', '崇文区', '110100'),
(4, '110104', '宣武区', '110100'),
...
CREATE TABLE IF NOT EXISTS `pc_zone_city` (
  `id` int(8) NOT NULL,
  `code` varchar(6) NOT NULL,
  `name` varchar(20) NOT NULL,
...
--
-- 转存表中的数据 `pc_zone_city`
--

INSERT INTO `pc_zone_city` (`id`, `code`, `name`, `provincecode`) VALUES
(1, '110100', '北京市', '110000'),
...
(344, '710100', '台  湾', '710000'),
(345, '810100', '香  港', '810000'),
(346, '820100', '澳  门', '820000');

-- --------------------------------------------------------

--
-- 表的结构 `pc_zone_province`
--

CREATE TABLE IF NOT EXISTS `pc_zone_province` (
  `id` int(11) NOT NULL,
  `code` varchar(6) NOT NULL,
  `name` varchar(20) NOT NULL
...
--
-- 转存表中的数据 `pc_zone_province`
--

INSERT INTO `pc_zone_province` (`id`, `code`, `name`) VALUES
(1, '110000', '北京市'),
(2, '120000', '天津市'),
(3, '130000', '河北省'),
(4, '140000', '山西省'),
...
--
-- Indexes for table `pc_coinfo`
--
ALTER TABLE `pc_coinfo`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_guestbook`
--
ALTER TABLE `pc_guestbook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_images`
--
ALTER TABLE `pc_images`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_members`
--
ALTER TABLE `pc_members`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Indexes for table `pc_pages`
--
ALTER TABLE `pc_pages`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_prefare`
--
ALTER TABLE `pc_prefare`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_pretrip`
--
ALTER TABLE `pc_pretrip`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_roles`
--
ALTER TABLE `pc_roles`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_trip`
--
ALTER TABLE `pc_trip`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_trip_order`
--
ALTER TABLE `pc_trip_order`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_trip_order_log`
--
ALTER TABLE `pc_trip_order_log`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_zone_area`
--
ALTER TABLE `pc_zone_area`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_zone_city`
--
ALTER TABLE `pc_zone_city`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pc_zone_province`
--
ALTER TABLE `pc_zone_province`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pc_admin`
--
ALTER TABLE `pc_admin`
  MODIFY `id` int(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pc_coinfo`
--
ALTER TABLE `pc_coinfo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pc_guestbook`
--
ALTER TABLE `pc_guestbook`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `pc_images`
--
ALTER TABLE `pc_images`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `pc_members`
--
ALTER TABLE `pc_members`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `pc_pages`
--
ALTER TABLE `pc_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `pc_prefare`
--
ALTER TABLE `pc_prefare`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `pc_pretrip`
--
ALTER TABLE `pc_pretrip`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `pc_roles`
--
ALTER TABLE `pc_roles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `pc_trip`
--
ALTER TABLE `pc_trip`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `pc_trip_order`
--
ALTER TABLE `pc_trip_order`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pc_trip_order_log`
--
ALTER TABLE `pc_trip_order_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pc_zone_area`
--
ALTER TABLE `pc_zone_area`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3145;
--
-- AUTO_INCREMENT for table `pc_zone_city`
--
ALTER TABLE `pc_zone_city`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=347;
--
-- AUTO_INCREMENT for table `pc_zone_province`
--
ALTER TABLE `pc_zone_province`
