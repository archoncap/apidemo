...
class JPush {
    ...
    const DEFAULT_LOG_FILE = "../log/jpush.log";
    const HTTP_GET = 'GET';
    ...
    public function push() {
        return new Jpush_PushPayload($this);
    }

    public function report() {
        return new Jpush_ReportPayload($this);
    }

    public function device() {
        return new Jpush_DevicePayload($this);
    }

    public function schedule() {
        return new Jpush_SchedulePayload($this);
    }
