...
class Captcha {
	...
	private static function words($len) {
		$charecters = "3456789abcdefghijkmnpqrstuvwxy";
		$words = "";
	 ...
	 * @param int $font_size
	 */
	public static function generate($len=4, $width = 108, $height = 30, $font_size = 18) {
	...
	public static function simple($len=4, $width = 48, $height = 22) {
		$words = self::words($len);
		session_start();
		$session_key = 'captcha';
		$_SESSION[$session_key] = strtolower($words);
